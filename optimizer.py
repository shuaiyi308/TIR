...
def build_optimizer(model, args, param_groups=None):
    ...
    lr = args.optim_lr
    weight_decay = args.optim_wegiht_decay
    momentum = args.optim_momentum
    sgd_dampening = args.optim_sdg_dampning
    sgd_nesterov = args.optim_sdg_nesterov
    rmsprop_alpha = args.optim_rmsprop_alpha
    adam_beta1 = args.optim_adam_beta1
    adam_beta2 = args.optim_adam_beta2
    staged_lr = args.optim_staged_lr
    new_layers = args.optim_new_layers
    base_lr_mult = args.optim_base_lr_mult
