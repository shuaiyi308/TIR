...
class TIR(nn.Module):
    ...
    def forward_suppress(self, x, txt_tokens, mask_ratio=0.7, temper_weight=0.5, params=None):
        #suppress sum = 5 
    ...
    def forward_amplify(self, x, txt_tokens, mask_ratio=0.7, temper_weight=0.5, params=None):
        #amplify sum = 1
    ...
    def forward(self, x, txt_tokens, mask_ratio=0.7, temper_weight=0.5, params=None):
        ...
        for i,block in enumerate(self.resblocks):  
            ...
            if is_visual:
                ...
                if i == 8 or i ==10:
                    ...
                    x = self.tir.forward(x, txt_feat, params.mask_ratio, params.temper_rate, params)
                #elif i >= 8:
