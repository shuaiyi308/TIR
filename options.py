...
def parse_args(script):
    ...
    parser.add_argument('-testset', default='CropDisease', help='CropDisease/EuroSAT/ISIC2018/ChestX, valid only when dataset=multi')
    ...
    parser.add_argument('-ratio', default=0.0001, type=float, help='') # for pretrained parameters lr
    parser.add_argument('-train_base_bs', default=128, type=int, help ='training batch size')
    ...
    parser.add_argument('-eval_datasets', nargs='+', type=str, default=['CropDiseases', 'EuroSAT', 'ISIC2018', 'ChestX'])
    #parser.add_argument('-eval_datasets', nargs='+', type=str, default=['cars', 'cub', 'places', 'plantae'])
    ...
    parser.add_argument('-svd_patch_logit_weight', type=float, default=0.0)
    parser.add_argument('-svd_cum_thresh', type=float, default=0.0)
    ...
    parser.add_argument('-flooding_thresh', type=float, default=0.0)
    parser.add_argument('-myNorm_flooding_thresh', type=float, default=0.0)
    parser.add_argument('-aux_param', type=float, default=0.9)
    ...
    parser.add_argument('-norm_branch', type=str, choices=['BN', 'IN', 'BN+IN'], default='BN+IN')
